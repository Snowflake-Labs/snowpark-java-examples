# Sentiment Analysis using CoreNLP in Java
...
After cloning the project, run `mvn package`. If all goes well, this will create **SentimentAnalysis_CoreNLP-1.0-SNAPSHOT-jar-with-dependencies.jar** in the target folder.
...
```
put file:///<full-path>/target/SentimentAnalysis_CoreNLP-1.0-SNAPSHOT-jar-with-dependencies.jar
...
returns numeric
language java
imports = ('@~/<YOUR_SNOWFLAKE_STAGE_NAME>/SentimentAnalysis_CoreNLP-1.0-SNAPSHOT-jar-with-dependencies.jar')
